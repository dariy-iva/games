...
//   });
  ...
  return (
    <>
      <div className="select" data-state={state}>
        <div className={`select__title ${state === 'active' ? 'select__title_active' : ''}`} data-default="Option 0" onClick={handleSelectClick}>{currentValueText}</div>
