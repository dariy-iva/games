    ...
    <section className="people">
      ...
      <ul className="people__list">
        {friendsList.map(friend => (
          <li key={friend.id} className={`people__friend  ${menuIsOpen ? '' : 'people__friend_collapsed'}`}>
            <div className="people__online"><img src={avatar} alt="avatar" className="people__avatar"/></div>
